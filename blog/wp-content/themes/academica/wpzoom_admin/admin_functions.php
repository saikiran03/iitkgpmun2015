...
$themename = "Academica Theme";
$shortname =  "wpzoom";

$options = array (

array(    "name" => "Academica Theme Settings",
        "type" => "title"),
...
array(    "name" => "Show static page on homepage?",
        "desc" => "Choose <strong>Yes</strong> if you want to show the content of a static page on the homepage.",
        "id" => $shortname."_featured_page_1_show",
...
array(    "name" => "Page to be displayed on homepage",
        ...
        "id" => $shortname."_featured_page_1",
        "categoryids" => $pagids,
        "categorynames" => $pagnames,
        "std" => "",
...
<div id="zoomWrap">
  <div id="zoomHead">
    ...
    <div id="zoomInfo"><ul><li class="documentation"><a href="http://www.wpzoom.com/documentation/academica">Documentation</a></li><li class="support"><a href="http://www.wpzoom.com/forum" target="_blank">Support Forum</a></li></ul></div>
  </div>
