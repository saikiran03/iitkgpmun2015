...
<div class="wrap">
	...
	<div class="column column-double column-content column-last">
		...
		<h1><?php _e('Archive for','wpzoom');?>: <?php single_tag_title(); ?></h1>
		...
		<h1><?php _e('Archive for','wpzoom');?>: <?php the_time('Y'); ?></h1>
	...
	<div class="column column-double column-last">
		...
		?>
		<h2><?php _e('Sorry, there are no posts in this category.', 'wpzoom');?></h2>
		<?php
		endif; ?>
